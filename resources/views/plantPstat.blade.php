...
<head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/js/bootstrap.min.js"></script>
  @if( $stat->lastItem() == 13)
    <meta http-equiv="REFRESH" CONTENT="60;url=/plantPstat?page=2">
    @elseif( $stat->lastItem() == 26)
    <meta http-equiv="REFRESH" CONTENT="60;url=/plantPstat?page=3">
    @else
    <meta http-equiv="REFRESH" CONTENT="60;url=https://cars.ierp.tk/carsDashboardPlantP">
  @endif
...
<body>
    ...
    <div class="container-fluid">
        <br>
        <legend>
            <h1 style="font-family:Roboto">QR M&T Dashboard <span style=" color: green; display: block; float: right; text-align: right; background-color:green;color:white;font-size:40px; border-radius:7px;">&nbsp;Plant P&nbsp;</span><input href="#" id="auto" onclick="$('#myModal').modal({'backdrop': 'static'});"
                    class="btn" hidden /></h1>
