...
<head>
    ...
    <meta charset="utf-8">
    @if( $job->lastItem() == 6)
    <meta http-equiv="REFRESH" CONTENT="10;url=/plantM?page=2&&currentjob=2&&machine=2">
    @elseif( $job->lastItem() == 12)
    <meta http-equiv="REFRESH" CONTENT="10;url=/plantM?page=3">
    @elseif( $job->lastItem() == 18)
    <meta http-equiv="REFRESH" CONTENT="10;url=/plantM?page=4">
    @elseif( $job->lastItem() == 24)
    <meta http-equiv="REFRESH" CONTENT="10;url=/plantM?page=5">
    @elseif( $job->lastItem() == 30)
    <meta http-equiv="REFRESH" CONTENT="10;url=/plantM?page=6">
    @elseif( $job->lastItem() == 36)
    <meta http-equiv="REFRESH" CONTENT="10;url=/plantM?page=7">
    @else
    <meta http-equiv="REFRESH" CONTENT="5;url=/plantMstat">
  @endif
        ...
        <center>
                ...
                <div class="card" style=" box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.5);">
                    <table style=" width:100%;  border-radius: 25px;">
                        ...
                        $date2 = date('Y-m-d'); 
                        $job2 = DB::table('qrmaster')->where('dt_opasgn', 'like', '%' .$date2. '%')->where('location', '=', 'Plant M')->where('trx_status','A')->distinct()->paginate(2,['stockcode','sonum'],'currentjob'); ?>
           ...
           <br>
                <div class="card" style=" box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.5);">
                    <table style=" width:100%;  border-radius: 25px;">
                        ...
                        <?php $user = DB::table('userqr')->where("location", "=", "Plant M")->where("deviceId", "!=", NULL)->paginate(2,['*'],'machine'); ?>
