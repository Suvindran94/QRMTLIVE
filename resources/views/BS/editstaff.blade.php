                    ...
                    <div class="col-12 grid-margin stretch-card">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form action="/updatestaff" method="post" class="forms-sample">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="exampleInputPassword4"
                                            value="{{$edit->dept}}" readonly>
                                        <input type='text' name='StaffID' value="{{$edit->StaffID}}" hidden>
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputPassword4">Password</label>
                                        <input type="text" class="form-control" id="exampleInputPassword4"
                                            value="{{$edit->password}}" readonly>
                                        <input type='text' name='password' value="{{$edit->password}}" hidden>
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleSelectGender">Role</label>
                                        <select class="form-control" style="color:black" name="role">
                                            <option value="{{$edit->role}}">{{$edit->role}}</option>
                                            <?php $user = DB::table('users')->distinct()->get(['role']); ?>
