...
<body>
 ...
 $prints2 = DB::table('moresolist')->where('asgnto','=', '')->count();
 $prints3 = DB::table('moresolist')->where('asgnto','!=', '')->count();
 $prints4 = DB::table('qrmaster')->where('dt_opscancomplete','!=', NULL)->count();
 $prints5 = DB::table('qrmaster')->where('dt_spvscanrev','!=', NULL)->count();
 $prints6 = DB::table('qrmaster')->where('dt_reprintseal','!=', NULL)->count();
 $prints7 = DB::table('qrmaster')->count();

 if($prints7 != 0){
    $var3 = ($prints6/$prints7)*100;
    $int5 = (int)$var3;
 }else{
    $var3 = 0;
    $int5 = 0;
 ...
 if($prints2 != 0 && $prints4 != 0){
 $var = ($prints3/$prints2)*100;
 $var2 = ($prints5/$prints4)*100;
 $int = (int)$var;
 $int2 = (int)$var2;
 $int3 = $prints2 - $prints3;
 $int4 = $prints4 - $prints5;
 }
 else{
 $var = 0;
 $var2 = 0;
                            ...
                            <td style="text-align:center;border: 1px solid transparent">
                                ...
                                <p style="font-size:15px">
                                    <span style="background-color:green; color:white; border-radius: 15px">&nbsp;Total
                                        Reprint&nbsp;</span>
                                    <br><?php echo $prints6?>/<?php echo $prints7?><br>Rarely</p>
                            </td>
                            <td style="text-align:center;border: 1px solid transparent">
                                <div class="chart" data-percent="0" style="color:grey">0%</div>
