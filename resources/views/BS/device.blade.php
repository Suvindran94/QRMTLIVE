                        ...
                        <div class="col-12 grid-margin">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <button type="button" class="btn btn-gradient-primary btn-sm" data-toggle="modal"
                                    ...
                                    <div class="table-responsive">
                                        <table class="table">
                                            ...
                                            <tbody>
                                                <?php $devices = DB::table('device')->paginate(5); 
                        $i = 1;
                        ?>
                            ...
                            if ($device->status == 'online'){
                              echo '<label class="badge badge-gradient-success">'.$device->status.' </label>';
                            }
                            else{
                              echo '<label class="badge badge-gradient-dark">'.$device->status.' </label>';
                            }
                            ?>
                                                    </td>
                                                    <td>{{$device->date}}</td>
                                                    ...
                                                    <td>
                                                        <form action="/updatedevice" method="get">
                                                            ...
                                                            <input type='text' name='deviceId'
                                                                value="{{$device->deviceId}}" hidden>
                                                            <input class="btn btn-gradient-success btn-rounded btn-fw"
                                                                style="width:120px" type='submit' value="Update" />
                                                        </form>
                                                        <input class="btn btn-gradient-danger btn-rounded btn-fw"
                                                            style="width:120px" value="Delete" />
                                                    </td>
                                                </tr>
                                                @endforeach
                                            </tbody>
                                        </table>
                                        {{$devices->appends(request()->input())->links('pagination::bootstrap-4')}}
                                        <br>
