...
<form action="/edit2/<?php echo $print->stockcode; ?>" method="post">
@endforeach
    <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
    <table>
        <tr>
            <td><input type='text' name='dt_reprintseal'
                    value='<?php date_default_timezone_set("Asia/Kuala_Lumpur"); echo date('Y-m-d\TH:i'); ?>' hidden />
            </td>
            @if( auth()->check() )
            <td><input type='text' name='reprintseal_by' value="{{ auth()->user()->name }}" hidden></td>
            @endif
            <td><input type='text' name='status' value='rp' hidden /> </td>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <?php
                echo '<div class="card" style=" height: 8.cm; width: 10.0cm">';
                echo '<div class="card-body" style="background-color: white">';
                echo '<table >';
                echo '<tr>';
                echo '<th width="50%">';
                echo '<span style="background-color: black; color:white; font-size:50px;" >'.substr($print->stockcode, 2,3).'</span>';
                echo '<p style="font-size:7px; margin-left:15px">'.$print->stockcode.'</p>';
                echo '</th>';
                echo'<th width="5%"><img style="height: 70px; width:100px" src="/img/barcodetemplate/item.png" /></th>';
                echo '</tr>';
                echo '<tr>';
                echo '<th style="font-size:10px;color:black">'.$print2->particular.'</th>';
                echo '<td rowspan="6">';
                ...
                echo '<a style="font-size:10px"><b>QTY : '.$print2->pbag.' NOS</b></a>';
                echo '</th>';
                echo '</tr>';
                echo '<tr>';
                echo '<td style="color:black">';
