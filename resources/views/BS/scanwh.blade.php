...
echo '<a href=BShome3 class="btn btn-success btn-lg" style="width:100px; margin-left:110px">Home</a>';
?>
                    ...
                    <center>
                        <table style="border-collapse: collapse; width: 100%;  border: 1px solid black;">
                            ...
                            <tr style="border: 1px solid black;">
                                ...
                                <td style="border: 1px solid black;text-align: center;">{{$data->dt_spvscanrev}}</td>
                                <?php
                    if ($data->whackwrev_by != NULL){
                                ...
                                <table align="center" style='border-collapse: collapse;'>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <input type="text" name="qrcode" value=""
                                                placeholder="QR Code" autofocus="autofocus" required>
                                            <script type="text/javascript">
                                        ...
                                        <input type='text' name='status' value="wh" hidden>
                                        @if( auth()->check() )
                                        <input type='text' name='whackwrev_by' value="{{ auth()->user()->name }}" hidden>
                                        @endif
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td><br><input class="btn btn-success btn-lg" type='submit' name='submit'
                                                value='Comfirm'></td>
                                                  <td><br><input type='text' name='dt_whackwrev'
