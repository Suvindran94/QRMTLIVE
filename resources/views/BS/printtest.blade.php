	...
	if($edits->design == 'default'){
										   ...
										   <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="2" style="text-transform: uppercase; font-size:13px"><b>QTY
                                                        :
                                                        {{$prints3->psmb}} {{$print2->uom}}</b></td>												<td style="text-align:center; font-size:14px;" colspan="2"><b>@if($edits->custStkID == '0') @else {{$print2->ARStkCode}} @endif</b></td>

                                               <td style="text-align:center; font-size:14px; text-align:right" colspan="5"><b>{{$prints3->number}}</b></td>
                                            </tr>
                                            <tr>
                                                <td colspan="6">
                                            ...
                                            <tr style="margin:0px;">
                                                <td style="font-size:10px"><b>S/O : {{$prints3->sonum}}</b></td>
        ...
        @endforeach
                                            ...
                                            <tr>
										      ...
										      <tr style="margin:0px;">
                                                <td colspan="6" style="font-size:10px; text-transform: uppercase;"><b>{{$prints3->stockcode}}</b></td>
                                            </tr>
										  @if($edits->qrwebsite == 0)
                                            <tr style="margin:0; ">
												...
												<?php
    $stk = substr($prints3->stockcode,0,1);
												if($stk == '2'){
