	...
	if($edits->design == 'default'){
	 ...
	 echo
										   ...
										   <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="2" style="text-transform: uppercase; font-size:13px"><b>QTY
                                                        :
                                                        {{$print->psmb}} {{$print2->uom}}</b></td>
												<td style="text-align:center; font-size:14px;" colspan="2"><b>@if($edits->custStkID == '0') @else {{$print2->ARStkCode}} @endif</b></td>
                                               <td style="text-align:center; font-size:14px; text-align:right" colspan="5"><b>{{$print->number}}</b></td>
                                            </tr>
                                            <tr>
                                                <td colspan="6">
        ...
        @endforeach
                                            ...
                                            <tr style="margin:0">
                                                <td colspan="1" style="font-size:9px; width:auto; height:auto;text-transform: uppercase; ">
