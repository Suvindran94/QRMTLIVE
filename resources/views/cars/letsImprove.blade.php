...
<div class="container">
    <div style="width: 1000px; margin: 140px 12px 0 auto;"class="row justify-content-center">
        <div class="col-md-12">
            ...
            <b><div class="card-header">{{ __('Lets Improve') }}</div><b>
...
<div class="card-body">
    ...
    <div class="form-group">
            {!! Form::label('deadline', 'Issue Date', ['class' => 'col-lg-10 control-label']) !!}
            <div class="col-lg-3">
    ...
    <div class="form-group">
            {!! Form::label('deadline', 'Return Date', ['class' => 'col-lg-10 control-label']) !!}
            <div class="col-lg-3">
            {{ Form::date('Duedate', new \DateTime(), ['class' => 'form-control']) }}
            </div>
        </div>
