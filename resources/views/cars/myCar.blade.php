...
<body>
<div class="modal fade" id="replyForm" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Reply Car</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body" style="margin:0 auto; width:580px;">

                <!-- Investigation -->
                <div class="form-group">
            {!! Form::label('textarea', 'Investigation (the root cause of the problem)', ['class' => 'col-lg-7 control-label'] ) !!}
            <div class="col-lg-10">
        ...
        $('textarea').maxlength({
              ...
              placement: 'top-left'
                        ...
                        <!-- Investigation -->
                        <div class="form-group">
            {!! Form::label('textarea', 'Corrective Action Plan', ['class' => 'col-lg-5 control-label'] ) !!}
            <div class="col-lg-10">
            {!! Form::textarea('textarea', $value = null, ['class' => 'form-control', 'rows' => 10, 'maxlength' => 300]) !!}
            </div>
            <script type="text/javascript">
                ...
                <tbody>
					...
					<td>1</td>
						...
						<td>
                            ...
                            <a href="#" class="Reply" title="Reply"  data-toggle="modal" data-target="#replyForm"><i class="material-icons">&#x21A9;</i></a>
					...
					<td>3</td>
						...
						<td>
						<a href="#" class="view" title="View" data-toggle="tooltip"><i class="material-icons">&#xe417;</i></a>
                        <a href="#" class="Reply" title="Reply"  data-toggle="madal" data-target="#replyForm"><i class="material-icons">&#x21A9;</i></a>
						</td>                        
                    </tr>
					<tr>
					<td>4</td>
