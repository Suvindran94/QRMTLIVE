            ...
            <div class="table-title">
                <div class="row">
					...
					<div class="col-sm-8">						
						...
						<a href="{{ url('pdfView') }}" target="_blank" class="btn btn-info"><i class="material-icons">&#xE24D;</i> <span>Export to Excel</span></a>
					</div>
                </div>
            </div>
                ...
                <tbody>
					...
					<td>1</td>
						...
						<td>
							...
							<a href="#" class="delete" title="Delete" data-toggle="modal" data-target="#confirm-delete"><i class="material-icons">&#xE5C9;</i></a>
