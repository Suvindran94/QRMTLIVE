...
<head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/js/bootstrap.min.js"></script>
  @if( $stat->lastItem() == 13)
    <meta http-equiv="REFRESH" CONTENT="60;url=/plantZstat?page=2">
    @elseif( $stat->lastItem() == 26)
    <meta http-equiv="REFRESH" CONTENT="60;url=/plantZstat?page=3">
    @else
    <meta http-equiv="REFRESH" CONTENT="60;url=https://cars.ierp.tk/carsDashboardv4">
  @endif
