...
<body>
    ...
    <div class="container-fluid">
        <br>
        <legend>
            <h1>QR M&T Dashboard <input href="#" id="auto" onclick="$('#myModal').modal({'backdrop': 'static'});"
                    class="btn" hidden /></h1>
        </legend>
                ...
                <center>
                    <ul1>
                        ...
                        <li1><img style="height: 60px; width:60px" src="/img/tracking/assign.png" /><a
                                style="color:black">Operator Assign</a></li1>
                        <li1><img style="height: 60px; width:60px" src="/img/tracking/printer.png" /><a
                                style="color:black">Print Complete</a></li1>
        ...
        <div class="row">
            <div class="col-sm-9">
                ...
                <?php 
                        ...
                        $date = date('Y-m-d'); 
                        $job3 = DB::table('qrmaster')->where('dt_opasgn', 'like', '%' .$date. '%')->get(); ?>
                ...
                <div class="card" style=" box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.5);">
                    <table style=" width:100%;  border-radius: 25px;">
                        <tr style="background:#ebfcfc;border-radius:5px;color:#498282; width:100%; ">
                            <td colspan="6">
                                <h4 style="color:black">&nbsp;&nbsp;Task Today</h4>
                            </td>
                        </tr>
                        <tr>
                            <td></td>
                        ...
                        date_default_timezone_set("Asia/Kuala_Lumpur"); 
                        $date = date('Y-m-d'); 
                        $job = DB::table('qrmaster')->where('dt_opasgn', 'like', '%' .$date. '%')->paginate(5); ?>
                        @foreach ($job as $jobs)
                        <tr style="border-radius:5px;color:#498282; width:100%;">

                            <td>
                                <center>
                                    <p style="margin-top:10px; color:black;font-size:25px">
                                        &nbsp;&nbsp;{{$jobs->sonum}}&nbsp;&nbsp;</p>
                                </center>
                            </td>
                            <td>
                            ...
                            if($jobs->printseal_by == NULL){
                                echo '<td>';
                                echo '<center>';
                                $user3 = DB::table('users')->where('StaffID', '=', $jobs->asgnto)->get();
                                foreach ($user3 as $user3){
                                    echo '<p style=" margin-top:10px; font-size:25px"><span
                                            style="background-color:green; color:white;padding:3px">&nbsp;&nbsp;'.$user3->name.'&nbsp;&nbsp;</span>
                                    </p>';
                                }
                                echo '</center>';
                            echo '</td>';
                            echo '<td>';
                                echo '<center>';
                                    echo '<p style=" margin-top:10px;font-size:25px"><span
                                            style="background-color:green; color:white;padding:3px">&nbsp;&nbsp;Print Completed&nbsp;&nbsp;</span>
                                    </p>';
                                echo '</center>';
                            echo '</td>';
                            echo '<td>';
                                echo '<center>';
                                    echo '<p style=" margin-top:10px;font-size:25px"><span
                                            style="background-color:red; color:white;padding:3px">&nbsp;&nbsp;Pending&nbsp;&nbsp;</span>
                                    </p>';
                                echo '</center>';
                            echo '</td>';
                            ...
                            echo '<td>';
                                echo '<center>';
                                    echo '<p style="margin-top:10px;font-size:25px"><span
                                            style="background-color:yellow; color:black;padding:3px">&nbsp;&nbsp;Operator Scan&nbsp;&nbsp;</span>
                                    </p>';
                                echo '</center>';
                            echo '</td>';
                            echo '<td>';
                            ...
                            echo '</td>';
                                ...
                                echo '<center>';
                                    echo '<p style=" margin-top:10px;font-size:25px"><span
                                            style="background-color:green; color:white;padding:3px">&nbsp;&nbsp;'.$jobs->opasgn_by.'&nbsp;&nbsp;</span>
                                    </p>';
                                echo '</center>';
                            echo '</td>';
                            echo '<td>';
                                echo '<center>';
                                    echo '<p style=" margin-top:10px;font-size:25px"><span
                                            style="background-color:blue; color:white;padding:3px">&nbsp;&nbsp;SPV Received&nbsp;&nbsp;</span>
                                    </p>';
                                echo '</center>';
                            echo '</td>';
                            echo '<td>';
                            ...
                            echo '</td>';
                                ...
                                echo '<center>';
                                    echo '<p style=" margin-top:10px;font-size:25px"><span
                                            style="background-color:green; color:white;padding:3px">&nbsp;&nbsp;QA&nbsp;&nbsp;</span>
                                    </p>';
                                echo '</center>';
                            echo '</td>';
                            echo '<td>';
                                echo '<center>';
                                    echo '<p style=" margin-top:10px;font-size:25px"><span
                                            style="background-color:pink; color:black;padding:3px">&nbsp;&nbsp;QA Checked&nbsp;&nbsp;</span>
                                    </p>';
                                echo '</center>';
                            echo '</td>';
                            echo '<td>';
                            ...
                            echo '</td>';
                                ...
                                echo '<center>';
                                    echo '<p style=" margin-top:10px;font-size:25px"><span
                                            style="background-color:green; color:white;padding:3px">&nbsp;&nbsp;Warehouse&nbsp;&nbsp;</span>
                                    </p>';
                                echo '</center>';
                            echo '</td>';
                            echo '<td>';
                                echo '<center>';
                                    echo '<p style=" margin-top:10px;font-size:25px"><span
                                            style="background-color:orange; color:black;padding:3px">&nbsp;&nbsp;Warehouse Received&nbsp;&nbsp;</span>
                                    </p>';
                                echo '</center>';
                            echo '</td>';
                            echo '<td>';
                            ...
                            echo '<td>';
                                echo '<center>';
                                    echo '<p style="margin-top:10px;font-size:25px"><span
                                            style="background-color:green; color:white;padding:3px">&nbsp;&nbsp;Completed&nbsp;&nbsp;</span>
                                    </p>';
                                echo '</center>';
                            echo '</td>';
                            }
            ...
            <div class="col-sm-3">
                <div class="card" style=" box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.5);">
                    <table style=" width:100%;  border-radius: 25px;">
                        ...
                        date_default_timezone_set("Asia/Kuala_Lumpur"); 
                        $date2 = date('Y-m-d'); 
                        $job2 = DB::table('qrmaster')->where('dt_opasgn', 'like', '%' .$date2. '%')->distinct()->get(['stockcode','sonum'])->paginate(2); ?>
                        @foreach ($job2 as $jobs2)
                        <tr style="border-radius:5px;color:#498282; width:100%;">
                            <td>
                                <p style="padding:3px; margin-top:10px; text-align:right"><span
                                        style="background-color:yellow; color:black;padding:3px">&nbsp;&nbsp;{{$jobs2->sonum}}&nbsp;&nbsp;</span>
                                </p>
                            </td>
                            <td colspan="3">
                                <p style="padding:3px; margin-top:10px; text-align:left"><span
                                        style="background-color:yellow; color:black;padding:3px">&nbsp;&nbsp;{{$jobs2->stockcode}}&nbsp;&nbsp;</span>
                                </p>
                            </td>
                        </tr>
                        @endforeach
                        <center>
                        {{$job2->appends(request()->input())->links('pagination::bootstrap-4')}}
                    </center>
                    </table>
                </div>
        <br>
        <div class="card" style=" box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.5);">
                    <table style=" width:100%;  border-radius: 25px;">
                        <tr style="background:#ebfcfc;border-radius:5px;color:#498282; width:100%; ">
                            <td colspan="4">
                                <h4 style="color:black">&nbsp;&nbsp;Device</h4>
                            </td>
                        </tr>
                        <?php $user = DB::table('userqr')->where("deviceId", "!=", NULL)->paginate(2); ?>
                        ...
                        <tr style="border-radius:5px;color:#498282; width:100%;">
                         ...
                         <?php $user2 = DB::table('qrmaster')->where('StaffID', '=', $user->StaffID)->get(); ?>
                         </td>
