    ...
    <div class="wrapper">
        ...
        <nav id="sidebar">
            ...
            <div class="sidebar-header">
                <h3>Barcode <br>System</h3>
            </div>

            <ul class="list-unstyled components">
            <li>
                    <a href="BShome"> <img style="height:35px; width:35px"
                            src="{{ asset('/img/BSicon/house.png') }}">&nbsp;&nbsp;Home</a>
                </li>

                <li>
                    <a href="view-records"> <img style="height:35px; width:35px"
                            src="{{ asset('/img/BSicon/barcodelist2.png') }}">&nbsp;&nbsp;Sales Order List</a>
                </li>
                <li hidden>
                    <a href="live_search"> <img style="height:35px; width:35px"
                            src="{{ asset('/img/BSicon/re.png') }}">&nbsp;&nbsp;Reprint Sticker</a>
                </li>
                ...
                <li hidden>
                    <a href="scan2"> <img style="height:35px; width:35px"
                            src="{{ asset('/img/BSicon/qr.png') }}">&nbsp;&nbsp;Warehouse Scan</a>
                </li>
                <li hidden>
                ...
                <li hidden>
                @if( auth()->check() )
                    <a href="BSprint/{{ auth()->user()->name }}" > <img style="height:35px; width:35px"
...
@if(auth()->user()->role == 25 || auth()->user()->role == 46 || auth()->user()->role == 3 || auth()->user()->role == 1 || auth()->user()->role == 30)
				                <li>
