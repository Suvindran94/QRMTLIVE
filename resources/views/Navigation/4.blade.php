    ...
    <div class="wrapper">
        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled components">
              ...
              ?>
				...
				@if(auth()->user()->role == 25 || auth()->user()->role == 46 || auth()->user()->role == 3 || auth()->user()->role == 1 || auth()->user()->role == 36 || auth()->user()->role == 30)
				                <li>
        ...
        <div id="content">
                ...
                <div class="container-fluid">
                    <ul class="nav navbar-nav ml-auto">
                        ...
                        <?php
								...
								$name2 = auth()->user()->role;
								if($name === "4" && $name2 === "21"){
									echo '<a href="/BShomesu"><img style="width:150px;" src=/img/poly.png></a></li>';
								}else{
								echo '<a href=/BShome'.$name.'><img style="width:150px;" src=/img/poly.png></a></li>';
							    }
						?>
                    </ul>
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="nav navbar-nav ml-auto">
                            <li class="nav-item">
                                @if( auth()->check() )
                                <a class="nav-link" style="font-color:black">Hi {{ auth()->user()->fname }}!</a>
                                @endif
                            </li>
            ...
            if (auth()->user()->role == "16") {
                ...
                echo '<button type="button" id="sidebarCollapse" class="btn btn-info" style=background:#00AEF0>
