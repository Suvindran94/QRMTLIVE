    ...
    <nav class="navbar fixed-top navbar-expand-lg navbar-light fixed-top">
        <div class="navbar-header d-flex col">
            <a class="navbar-brand" href="/">
                <img src="{{ asset('/img/logo.png') }}" style="width:100px; height:30px;" alt="">
            </a>
            ...
            <ul class="nav navbar-nav navbar-right ml-auto">
                <li class="nav-item">
                    <a data-toggle="dropdown" class="nav-link dropdown-toggle" style="margin-top:5px" href="#">{{ trans('sentence.login')}}</a>
                        ...
                        <li>
                            <form action="home">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control" placeholder="{{ trans('sentence.staffID')}}"
                                        required="required">
                                </div>
                                <div class="form-group">
                    ...
                    <ul class="dropdown-menu form-wrapper">
                        <li>
                            <form action="/examples/actions/confirmation.php" method="post">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control" placeholder="Staff ID" required="required">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <select class="form-control form-control-sm">
                                        ...
                                        <option value="">Top Manager</option>
